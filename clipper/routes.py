...
from clipper.tasks import process_video_background
#from helper.calculate_tokens import calculate_required_tokens
from queue_config import clipper_queue
...
def clipper():
    ...
    clipper_queue.enqueue(
        ...
        app._get_current_object(),  # pass app context
        job.id,
        save_path,
        job_dir,
        result_ttl=0  # we store result in DB
    )
